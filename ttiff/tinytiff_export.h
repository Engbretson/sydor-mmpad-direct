...
#      define TINYTIFF_EXPORT __attribute__((visibility("default")))
#    else
...
#    define TINYTIFF_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef TINYTIFF_DEPRECATED
#  define TINYTIFF_DEPRECATED __attribute__ ((__deprecated__))
#endif
